...
btn_ob = tk.Button(root, text="(", command=lambda: add_to_calculation("("), width=5, font=("ariel",14))
btn_ob.grid(row=5, column=1)

btn_cb = tk.Button(root, text=")", command=lambda: add_to_calculation(")"), width=5, font=("ariel",14))
...
btn_clr= tk.Button(root, text="clr", command=clear_field, width=11, font=("ariel",14))
